...
import { FiCpu, FiCode, FiLayers, FiTrendingUp } from "react-icons/fi";
...
const AboutMe = (): React.ReactElement => {
  ...
  return (
    <div
      id="aboutMe"
      ref={sectionRef}
      className="relative overflow-hidden scroll-mt-24 bg-gradient-to-br from-white via-gray-50 to-gray-100 py-16 lg:py-24"
    >
      {/* Background Elements with Parallax */}
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute top-1/4 -left-20 w-64 h-64 rounded-full bg-gradient-to-r from-blue-50 to-gray-100 opacity-30"
          style={{ transform: `translateY(${scrollY * 0.1}px)` }}
        />
        <div
          className="absolute bottom-1/4 -right-20 w-80 h-80 rounded-full bg-gradient-to-l from-blue-50 to-gray-100 opacity-30"
          style={{ transform: `translateY(${scrollY * 0.15}px)` }}
        />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-64 bg-gradient-to-r from-transparent via-gray-200/10 to-transparent opacity-20"
          style={{
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          <Title className="mb-12 lg:mb-16">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center justify-center">
            ...
            <div
              ref={imageRef}
              className="lg:w-2/5 relative transition-transform duration-300 ease-out"
            >
              <div className="relative group">
                ...
                >
                  ...
                  <div className="flex justify-center gap-4 mt-6">
                    <CarouselPrevious className="bg-white border-gray-300 shadow-md" />
                    <CarouselNext className="bg-white border-gray-300 shadow-md" />
                  </div>
                </Carousel>

                {/* Decorative Elements */}
                <div className="absolute -bottom-4 -left-4 w-24 h-24 border border-gray-300 rounded-xl opacity-20 -rotate-12" />
                <div className="absolute -top-4 -left-4 w-16 h-16 border border-gray-300 rounded-xl opacity-20 rotate-12" />
              </div>
            </div>
            ...
            <div
              ref={contentRef}
              className="lg:w-3/5 space-y-8 transition-all duration-700 ease-out"
            >
              <div className="space-y-6">
                ...
                <div className="space-y-6 text-gray-700 leading-relaxed">
                  ...
                  <div className="bg-gradient-to-r from-gray-50 to-white border border-gray-100 rounded-xl p-6 space-y-4 shadow-sm">
                  ...
                  <p className="text-lg font-medium text-gray-900 pt-4 border-t border-gray-100">
